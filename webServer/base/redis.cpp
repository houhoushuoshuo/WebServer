...
{
    MutexLockGuard lock_(m_redis_lock);
...
{
    string board;
    board = getReply("zrange HAT 0 -1 withscores");
    //完整性校验
...
void redis_clt::board_exist()
{
    ...
    if (board != "1")
    {
        ...
        getReply("DEL GOT");
        getReply("zadd HAT 0 Brook");
        getReply("zadd HAT 0 Chopper");
        getReply("zadd HAT 0 Franky");
        getReply("zadd HAT 0 Luffy");
        getReply("zadd HAT 0 Nami");
        getReply("zadd HAT 0 Robin");
        getReply("zadd HAT 0 Sanji");
        getReply("zadd HAT 0 Usopp");
        getReply("zadd HAT 0 Zoro");
        cout << "redis init ok" << endl;
    }
    //return board;
}
/*
